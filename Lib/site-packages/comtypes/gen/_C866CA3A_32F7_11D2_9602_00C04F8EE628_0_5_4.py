...
__all__ = [
    ...
    'SVP_1', 'DISPID_SLWsCount', 'SAFT8kHz16BitMono',
    'DISPID_SGRSAddRuleTransition',
    'SpeechPropertyComplexResponseSpeed', 'SP_VISEME_20',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT8kHz16BitStereo',
    'DISPID_SVSLastResult', 'DISPID_SpeechAudio',
    'SWPKnownWordPronounceable', 'ISpeechBaseStream',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpeechRuleState', 'SVF_Stressed',
    'DISPID_SPIProperties', 'DISPID_SRRAudio', 'SVP_4',
    'eLEXTYPE_PRIVATE1', 'SpeechUserTraining', 'DISPID_SPCIdToPhone',
    'DISPID_SRCState', 'SAFT11kHz16BitMono', 'SBOPause',
    'SAFT24kHz16BitMono', 'DISPID_SVSpeak', 'DISPID_SLGetWords',
    'ISpeechMemoryStream', 'DISPID_SVVoice', 'DISPID_SRProfile',
    'SDA_Consume_Leading_Spaces', 'SRERecoOtherContext',
    'ISpeechVoice', 'DISPID_SGRInitialState',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPCPhoneToId',
    'SpeechEngineConfidence', 'SPFILEMODE',
    'DISPID_SRCERecognizerStateChange', 'SpeechPropertyResourceUsage',
    'SVSFIsFilename', 'DISPID_SRRPhraseInfo', 'SVEVoiceChange',
    'DISPID_SPIReplacements', 'DISPID_SVSkip', 'ISpPhrase',
    'SPVPRI_OVER', 'SVF_Emphasis', 'ISpEventSource', 'SPAUDIOOPTIONS',
    'SpeechAddRemoveWord', 'SpeechGrammarWordType',
    'Speech_StreamPos_Asap', 'SpStream',
    'DISPID_SPIGetDisplayAttributes', 'SpeechLexiconType',
    'SREPhraseStart', 'DISPID_SRGetPropertyNumber', 'SP_VISEME_9',
    'SAFT44kHz8BitMono', 'DISPID_SGRsDynamic', 'eLEXTYPE_PRIVATE5',
    'SGSEnabled', 'SAFTADPCM_8kHzMono', 'DISPID_SPRules_NewEnum',
    'SPLO_DYNAMIC', 'DISPID_SRCEStartStream',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechObjectTokens',
    ...
    'SPVPRIORITY', 'SPEI_MAX_TTS', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPRsItem', 'SDTProperty', 'DISPID_SPIGetText',
    'SPAUDIOBUFFERINFO', 'SGSDisabled', 'DISPID_SLPPartOfSpeech',
    'SGPronounciation', 'SPDKL_CurrentConfig',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SRGDictationLoad',
    'SPAR_Medium', 'ISpVoice', 'SREBookmark', 'SRAInterpreter',
    'SPXMLRESULTOPTIONS', 'ISpeechPhraseProperties',
    'DISPID_SOTGetDescription', 'DISPIDSPTSI', 'SPPS_NotOverriden',
    'DISPID_SGRsCommit', 'DISPID_SpeechPhoneConverter',
    'SpeechAudioFormatType', 'DISPID_SPEs_NewEnum', 'ISpeechLexicon',
    'SpAudioFormat', 'SPCT_COMMAND', 'DISPID_SRGId',
    'SpeechDataKeyLocation', 'DISPID_SRGState', 'ISpeechMMSysAudio',
    'ISequentialStream', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechPhraseElements', 'DISPID_SRState',
    'DISPID_SpeechFileStream', 'SGDSActive', 'DISPID_SBSWrite',
    'SPPHRASEREPLACEMENT', 'DISPID_SCSBaseStream',
    'DISPID_SMSADeviceId', 'DISPID_SWFEChannels', 'SRERequestUI',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SOTCGetDataKey',
    'SAFTExtendedAudioFormat',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPCS_DISABLED',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SBSSeek',
    ...
    'SAFTGSM610_11kHzMono', 'SPPHRASE', 'SPRECOCONTEXTSTATUS',
    'SpeechTokenValueCLSID', 'SpNotifyTranslator',
    'DISPID_SGRSTransitions', 'SRSActive', 'SVSFIsNotXML',
    'SPCATEGORYTYPE', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPAs_NewEnum', 'DISPID_SOTRemove', 'ISpRecognizer3',
    'SPRST_NUM_STATES', 'DISPID_SPRuleChildren',
    'DISPID_SRSCurrentStreamPosition',
    'SWPUnknownWordUnpronounceable',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCRecognizer',
    'eLEXTYPE_PRIVATE6', 'SVP_18', 'ISpeechAudioBufferInfo',
    'SRSEIsSpeaking', 'DISPID_SVRate',
    'DISPID_SRSCurrentStreamNumber', 'STSF_FlagCreate',
    'SpeechVoiceSpeakFlags', 'DISPID_SOTDataKey',
    'DISPID_SRGCmdLoadFromFile', 'SDTReplacement',
    'DISPID_SVEEnginePrivate', 'eLEXTYPE_APP',
    'SpeechBookmarkOptions', 'SPGS_ENABLED',
    'SpeechRecoProfileProperties', 'DISPID_SAFGuid',
    'DISPID_SRAudioInput', 'SPEI_SOUND_START', 'SpeechRuleAttributes',
    'SAFTText', 'SPRS_INACTIVE', 'ISpRecoGrammar', 'STCAll',
    'SPSTREAMFORMATTYPE', 'SPSMF_UPS', 'SAFT11kHz8BitMono', 'SBONone',
    'DISPID_SRRecognizer', 'SRTEmulated', 'SPPS_Noncontent',
    'ISpeechPhraseElements', 'SRTExtendableParse',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPRuleParent', 'ISpeechPhraseRules',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SOTCategory',
    'DISPID_SRCreateRecoContext', 'SAFTCCITT_uLaw_22kHzMono',
    'STSF_AppData', 'DISPID_SPILanguageId', 'DISPID_SPEAudioSizeTime',
    'DISPID_SLPSymbolic', 'ISpeechLexiconPronunciations',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SOTCDefault',
    'SINoSignal', 'DISPID_SRCResume', 'ISpeechRecoGrammar',
    'SP_VISEME_16', 'SPEI_START_INPUT_STREAM', 'DISPID_SLPsItem',
    'DISPID_SRCRetainedAudio', 'DISPID_SGRSAddWordTransition',
    'SVEWordBoundary', 'DISPID_SMSGetData', 'SpWaveFormatEx',
    'DISPID_SpeechPhraseBuilder', 'SPAO_NONE', 'SpeechRunState',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechVoiceSkipTypeSentence',
    'SAFT22kHz16BitMono', 'DISPID_SPRulesItem', 'SAFT44kHz16BitMono',
    'LONG_PTR', 'SPWT_DISPLAY', '_SPAUDIOSTATE', 'eLEXTYPE_PRIVATE7',
    'SPWORD', 'SpeechEngineProperties', 'DISPID_SMSSetData',
    'DISPID_SOTIsUISupported', 'DISPID_SRGRecoContext',
    'SPTEXTSELECTIONINFO', 'SAFT22kHz16BitStereo',
    'SPEI_SR_AUDIO_LEVEL', 'eLEXTYPE_RESERVED6',
    'DISPID_SRRTStreamTime', 'SWTDeleted', 'DISPIDSPTSI_ActiveLength',
    'SPCS_ENABLED', 'DISPID_SOTCId', 'DISPID_SRGCmdSetRuleState',
    'ISpeechResourceLoader', 'DISPID_SpeechXMLRecoResult',
    'SPWORDPRONUNCIATION', 'DISPID_SRCEAdaptation', 'SGLexical',
    'DISPID_SVGetAudioInputs', 'SPEI_RESERVED3', 'SVSFIsXML',
    'eLEXTYPE_USER_SHORTCUT', 'STCInprocHandler',
    'IInternetSecurityMgrSite', 'DISPID_SABIBufferSize',
    'SVSFPurgeBeforeSpeak', 'SPSERIALIZEDRESULT',
    'ISpeechPhraseInfoBuilder', 'DISPID_SDKGetStringValue',
    'SpResourceManager', 'SPEI_SR_BOOKMARK', 'SREPrivate',
    '__MIDL_IWinTypes_0009', 'DISPID_SVSpeakStream',
    'ISpXMLRecoResult', 'DISPID_SGRSTPropertyId',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechPhraseRule',
    'SP_VISEME_18', 'DISPID_SRGRules', 'DISPID_SpeechAudioBufferInfo',
    'SGDisplay', 'SVP_9', 'ISpMMSysAudio', 'DISPID_SWFEFormatTag',
    'SVSFParseMask', 'SPCONTEXTSTATE', 'SGLexicalNoSpecialChars',
    'ISpeechRecognizer', 'ISpeechGrammarRules', 'SAFT12kHz8BitStereo',
    'SPEI_END_INPUT_STREAM', 'SPSModifier', 'SPAR_Low',
    'SPDKL_DefaultLocation', 'DISPID_SGRName', 'ISpRecoGrammar2',
    'DISPID_SPPsCount', 'SAFTADPCM_22kHzStereo', 'SpeechDiscardType',
    'DISPID_SLWsItem', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPFM_OPEN_READONLY', 'SpeechWordType', 'ISpNotifySink',
    'DISPID_SRCEPropertyStringChange', 'SPEI_SENTENCE_BOUNDARY',
    'SPSFunction', 'SPAS_CLOSED', 'ISpeechWaveFormatEx',
    ...
    'SREHypothesis', 'SP_VISEME_7', 'DISPID_SRGSetWordSequenceData',
    'IInternetSecurityManager', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SMSALineId', 'SASRun', 'DISPID_SPAStartElementInResult',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRSTPropertyValue',
    'SGRSTTWildcard', 'DISPID_SRCEBookmark',
    'SpeechAudioFormatGUIDWave', 'SPSNoun', 'ISpeechLexiconWord',
    'SSFMOpenReadWrite', 'DISPID_SRGetFormat',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRAddResource',
    'SpeechCategoryVoices', 'DISPID_SpeechPhraseProperty',
    'STCRemoteServer', 'SPSERIALIZEDPHRASE', 'SRTStandard',
    'SPEI_FALSE_RECOGNITION', 'SpeechTokenKeyFiles',
    'SPPS_SuppressWord', 'SPLOADOPTIONS', 'DISPID_SWFESamplesPerSec',
    'ISpStreamFormatConverter', 'SPRECORESULTTIMES',
    'SpeechTokenShellFolder', 'SpeechStreamSeekPositionType',
    'SRAImport', 'DISPID_SGRsCount', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCEInterference', 'ISpeechRecoResult2',
    'SDKLLocalMachine', 'SP_VISEME_15', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechMicTraining', 'SPRST_ACTIVE_ALWAYS', 'SGRSTTDictation',
    'SpeechAudioProperties', 'DISPID_SpeechRecognizerStatus',
    'SVSFUnusedFlags', 'SDTRule', 'SITooSlow', 'IStream',
    'SAFT12kHz8BitMono', 'DISPID_SPAsCount', 'SVSFNLPMask', 'SASStop',
    'SINone', 'ISpResourceManager', 'SPVOICESTATUS',
    'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPGRAMMARWORDTYPE',
    'DISPID_SGRAttributes', 'SPRST_INACTIVE',
    'DISPID_SVAlertBoundary', 'SpCustomStream', 'SVEPrivate',
    'DISPID_SPPChildren', 'DISPID_SREmulateRecognition',
    'DISPID_SDKSetStringValue', 'SDKLDefaultLocation',
    'SDKLCurrentUser', 'SP_VISEME_14', 'eWORDTYPE_ADDED',
    'DISPID_SLPLangId', 'SpStreamFormatConverter',
    'eLEXTYPE_PRIVATE16', 'SPGS_DISABLED', 'SAFT32kHz8BitMono',
    'DISPID_SPEDisplayAttributes', 'SAFTCCITT_ALaw_44kHzStereo',
    'IEnumSpObjectTokens', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpRecoResult', 'DISPID_SRRAlternates',
    'DISPID_SPEAudioTimeOffset', 'ISpeechPhraseElement',
    'DISPID_SADefaultFormat', 'ISpeechVoiceStatus',
    'DISPID_SpeechPhraseInfo', 'SpeechGrammarState',
    'eLEXTYPE_RESERVED7', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechGrammarRuleState', 'SPSHT_Unknown',
    'DISPID_SRCPause', 'DISPID_SVEventInterests',
    'DISPID_SVSpeakCompleteEvent', 'SpeechRegistryLocalMachineRoot',
    'SPVPRI_ALERT', 'STCLocalServer', 'SVP_16', 'SPINTERFERENCE_NONE',
    ...
    'SVSFVoiceMask', 'ISpeechPhraseReplacements', 'DISPID_SRRTimes',
    'SPPS_Unknown', 'SpeechAudioState',
    'SPINTERFERENCE_LATENCY_WARNING', 'eLEXTYPE_PRIVATE13',
    'SP_VISEME_5', 'ISpShortcut', 'DISPID_SPIAudioStreamPosition',
    'ISpDataKey', 'SPADAPTATIONRELEVANCE', 'SPCT_SUB_COMMAND',
    'DISPID_SOTMatchesAttributes', 'DISPID_SASNonBlockingIO',
    'SPWF_SRENGINE', 'DISPID_SOTCEnumerateTokens', 'SVP_2', 'SVP_17',
    'ISpeechAudioStatus', 'SpeechRecoContextState',
    'SSFMCreateForWrite', 'DISPID_SPRuleFirstElement', 'DISPIDSPRG',
    'SPAS_STOP', 'SITooQuiet', 'SpeechAudioFormatGUIDText',
    'DISPID_SPACommit', 'ISpPhraseAlt', 'SITooLoud', 'WAVEFORMATEX',
    'DISPID_SRCRequestedUIType', 'DISPID_SAStatus',
    'eLEXTYPE_PRIVATE9', 'SVSFDefault', 'DISPID_SRRGetXMLErrorInfo',
    'SPWT_PRONUNCIATION', 'DISPID_SLWs_NewEnum', 'SpeechVoiceEvents',
    'SVP_21', 'Speech_Default_Weight', 'SPCT_DICTATION',
    'SVEBookmark', 'SPEI_SR_RETAINEDAUDIO', 'DISPID_SGRSTs_NewEnum',
    'SPDKL_LocalMachine',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechLexiconWords', 'SGRSTTRule', 'SpeechAllElements',
    'SpeechInterference', 'STCInprocServer',
    'SpeechDictationTopicSpelling', 'SAFT48kHz16BitStereo',
    ...
    'DISPID_SVStatus', 'DISPID_SRRRecoContext', 'SPEVENTSOURCEINFO',
    'eLEXTYPE_RESERVED4', 'DISPID_SLGetPronunciations',
    'SPSHORTCUTPAIR', 'eLEXTYPE_PRIVATE4',
    'SpeechCategoryAppLexicons', 'SAFT32kHz8BitStereo',
    'ISpeechRecoResultDispatch', 'SpeechSpecialTransitionType',
    'DISPID_SpeechObjectTokenCategory', 'ISpLexicon',
    'DISPID_SVSLastBookmark', 'SAFT12kHz16BitStereo',
    'DISPID_SABIEventBias', 'ISpStreamFormat', 'SDTDisplayText',
    'ISpeechTextSelectionInformation', 'SSSPTRelativeToStart',
    'SPAUDIOSTATUS', 'SPINTERFERENCE_NOISE', 'ISpRecoCategory',
    'SPPHRASEELEMENT', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SVEPhoneme', 'SVP_6', 'SpeechWordPronounceable',
    'DISPID_SOTRemoveStorageFileName', 'SpMemoryStream',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPEVENT',
    'DISPID_SGRsCommitAndSave', 'SRADefaultToActive',
    'ISpeechPhoneConverter', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFT48kHz8BitStereo', 'DISPID_SPIRule', 'tagSPPROPERTYINFO',
    'SPSHT_OTHER', 'SVSFParseSsml', 'SPEI_ADAPTATION',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRDisplayUI', 'DISPID_SDKEnumValues',
    'SAFTADPCM_8kHzStereo', 'DISPID_SLGenerationId',
    'SAFT8kHz8BitStereo', 'SPSUnknown', 'DISPID_SPIGrammarId',
    'SAFTGSM610_8kHzMono', 'SpInprocRecognizer',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRGReset',
    'SpeechGrammarTagDictation', 'DISPID_SPEPronunciation',
    'ISpNotifyTranslator', 'SPGS_EXCLUSIVE', 'DISPID_SPPsItem',
    'SVF_None', 'SPPS_Modifier', 'SpeechStreamFileMode',
    'DISPID_SGRSRule', 'DISPID_SVEWord', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechGrammarRule', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRCEAudioLevel', 'SRESoundStart', 'SVSFParseAutodetect',
    'SpeechCategoryRecognizers', 'SPBO_TIME_UNITS',
    'SDKLCurrentConfig', 'SpTextSelectionInformation',
    'DISPID_SGRAddState', 'DISPID_SPEDisplayText', 'SVP_14',
    'SAFTADPCM_44kHzMono', 'DISPID_SVVolume', 'ISpObjectWithToken',
    'SPCT_SUB_DICTATION', 'SAFT11kHz16BitStereo',
    'DISPID_SPIStartTime', 'ISpRecoContext2', 'ISpNotifySource',
    'SECNormalConfidence', 'SPPS_Interjection',
    'SPINTERFERENCE_NOSIGNAL', 'ISpeechObjectTokens',
    'SECFIgnoreCase', 'SGSExclusive', 'DISPID_SOTDisplayUI',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_PRIVATE8', 'DISPID_SLWWord', 'SDTAudio',
    '_ISpeechVoiceEvents', 'SVPAlert', 'SP_VISEME_0', 'SPCT_SLEEP',
    'SpCompressedLexicon', 'SPAS_RUN', 'DISPID_SpeechMemoryStream',
    'DISPID_SDKGetBinaryValue', 'DISPID_SVEViseme',
    'SpeechTokenKeyAttributes', 'SRSInactiveWithPurge',
    'DISPID_SVDisplayUI', 'SpeechFormatType',
    '_ISpeechRecoContextEvents', 'DISPID_SGRSTsCount',
    'DISPID_SAFType', 'SP_VISEME_10', 'SpPhoneConverter',
    ...
    'SAFTGSM610_44kHzMono', 'DISPID_SPEsItem', 'DISPID_SPRuleName',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPEI_HYPOTHESIS',
    'DISPID_SGRSTPropertyName', 'SPINTERFERENCE', 'SPAR_High',
    'SPEI_PHRASE_START', 'SVEAllEvents', 'SP_VISEME_13', 'SWTAdded',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRRSaveToMemory',
    'DISPID_SVGetVoices', 'DISPID_SASState', 'SPPS_RESERVED1',
    'SPEI_MAX_SR', 'eLEXTYPE_PRIVATE19', 'SPLEXICONTYPE',
    'ISpeechPhraseReplacement', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRSTType', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SREAdaptation', 'DISPID_SRGSetTextSelection',
    'SAFTCCITT_ALaw_8kHzMono', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFT24kHz16BitStereo', 'DISPID_SpeechDataKey',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPIEngineId',
    'SDA_No_Trailing_Space', 'DISPID_SGRs_NewEnum', 'SVP_15',
    'DISPID_SAFGetWaveFormatEx',
    'SpeechPropertyLowConfidenceThreshold', 'SpSharedRecognizer',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE10', 'SAFTGSM610_22kHzMono',
    'SPEI_TTS_PRIVATE', 'SVSFParseSapi', 'DISPID_SRGetPropertyString',
    'SPBO_AHEAD', 'SPBOOKMARKOPTIONS', 'DISPID_SRRAudioFormat',
    'SPINTERFERENCE_TOOSLOW', 'SREInterference',
    'DISPID_SVSRunningState', 'SpObjectToken',
    'DISPID_SVESentenceBoundary', 'SPEI_PROPERTY_STRING_CHANGE',
    'SP_VISEME_21', 'DISPID_SRCCmdMaxAlternates', 'SAFT48kHz8BitMono',
    'DISPID_SPPConfidence', 'Speech_Max_Pron_Length',
    'SpeechAudioVolume', 'SECFIgnoreKanaType',
    'DISPID_SRAudioInputStream', 'DISPID_SRCBookmark',
    'SAFT16kHz8BitMono', 'SPEI_RECO_OTHER_CONTEXT', 'SPLO_STATIC',
    'DISPID_SOTsItem', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRCEHypothesis', 'SRARoot', 'DISPID_SPRuleConfidence',
    'SAFT22kHz8BitMono', 'SREAllEvents', 'SPEI_REQUEST_UI',
    'SP_VISEME_1', 'SpeechTokenContext', 'DISPID_SVGetProfiles',
    'SSSPTRelativeToEnd', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SpeechPhraseRule', 'SPEI_PHONEME',
    'ISpeechObjectTokenCategory', 'SDTLexicalForm',
    'DISPID_SRGDictationUnload', 'DISPID_SPRuleEngineConfidence',
    'ISpeechObjectToken', 'DISPID_SVAudioOutput', 'SVPNormal',
    'DISPID_SPELexicalForm', 'DISPIDSPTSI_ActiveOffset',
    'SAFT32kHz16BitMono', 'DISPID_SASCurrentDevicePosition',
    'SRAONone', 'DISPID_SRStatus', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPPFirstElement', 'DISPID_SFSOpen', 'DISPID_SpeechVoice',
    'SP_VISEME_17', 'DISPID_SRGCommit', 'SGRSTTTextBuffer',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRCESoundEnd', 'SPEI_RESERVED2',
    'SPSHT_EMAIL', 'SINoise', 'SRAORetainAudio',
    'DISPID_SPPEngineConfidence', 'DISPID_SLRemovePronunciation',
    'SLTUser', 'SVEEndInputStream', 'DISPID_SRCSetAdaptationData',
    'DISPID_SPRuleNumberOfElements',
    'DISPID_SVSyncronousSpeakTimeout', 'eLEXTYPE_PRIVATE17',
    'DISPID_SpeechPhraseElement', 'DISPID_SpeechCustomStream',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'Speech_Max_Word_Length',
    'SPAR_Unknown', 'SVP_20', 'STSF_CommonAppData',
    'SpeechPropertyHighConfidenceThreshold', 'IEnumString',
    'DISPID_SGRsFindRule', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRCVoice', 'SPWORDTYPE', 'SRADynamic', 'SSFMCreate',
    'ISpeechPhraseAlternate', 'SAFTADPCM_22kHzMono',
    'SpeechCategoryPhoneConverters', 'SpFileStream',
    'SPEI_TTS_AUDIO_LEVEL', 'SPSHORTCUTTYPE', 'DISPID_SMSAMMHandle',
    'SRSInactive', 'DISPID_SDKOpenKey', 'SPSHT_NotOverriden',
    'DISPID_SRCERequestUI', 'SpeechPropertyResponseSpeed',
    'SPRECOGNIZERSTATUS', 'SpPhoneticAlphabetConverter',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SLWLangId',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_RESERVED5',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SASetState',
    'eLEXTYPE_PRIVATE18', 'SPRST_ACTIVE', 'SVSFNLPSpeakPunc',
    'DISPID_SWFEBitsPerSample', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechAudioStatus', 'SPPS_RESERVED2',
    'SpeechRecognitionType', 'SAFT16kHz16BitStereo',
    'DISPID_SWFEExtraData', 'SFTInput', 'SPEI_MIN_SR',
    'SpeechDisplayAttributes', 'SVP_11', 'SpeechLoadOption',
    'SPFM_OPEN_READWRITE', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPAPhraseInfo', 'SPEI_UNDEFINED', 'SP_VISEME_19',
    'SAFTDefault', 'SpObjectTokenCategory', 'tagSTATSTG',
    'STSF_LocalAppData', 'DISPID_SPERequiredConfidence',
    'SPEI_MIN_TTS', 'DISPIDSPTSI_SelectionLength', 'SVP_7',
    'DISPID_SLPsCount', 'SPGRAMMARSTATE', 'DISPID_SOTId',
    'DISPID_SRCRetainedAudioFormat', 'SpeechVisemeFeature', 'SPSLMA',
    'SVP_19', 'SPDKL_CurrentUser', 'SREStreamEnd', 'SPPS_LMA',
    'SAFTADPCM_11kHzMono', 'SRTReSent', 'SpeechTokenKeyUI',
    'SpeechVoiceCategoryTTSRate', 'SVEPhoneme', 'DISPID_SPIElements',
    'SRATopLevel', 'DISPID_SVSPhonemeId', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLAddPronunciation',
    'SPEI_RESERVED1', 'DISPID_SGRSTRule', 'DISPID_SRRSetTextFeedback',
    'SPEI_VOICE_CHANGE', 'SPBO_NONE', 'DISPID_SBSRead', 'SPRULESTATE',
    'DISPID_SRRGetXMLResult', 'DISPID_SDKDeleteValue',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechLexicon', 'SP_VISEME_3', 'DISPID_SVPause',
    'SPSInterjection', 'ISpeechDataKey', 'DISPID_SVAudioOutputStream',
    'SP_VISEME_2', 'SVP_12', 'SPRULE', 'DISPID_SRRTTickCount',
    'ISpRecoContext', 'DISPID_SLPPhoneIds', 'SpeechRecoEvents',
    'SECLowConfidence', 'DISPID_SRCEEndStream', 'SPBINARYGRAMMAR',
    'SpeechVisemeType', 'ISpPhoneticAlphabetSelection',
    'SpeechCategoryRecoProfiles', 'DISPID_SpeechGrammarRules',
    'DISPID_SVSInputSentenceLength', 'SAFT44kHz8BitStereo',
    'SPWORDPRONUNCIATIONLIST', 'SPRECOSTATE',
    'DISPID_SPANumberOfElementsInResult', 'SECFIgnoreWidth',
    'SpVoice', 'ISpeechAudioFormat', 'DISPID_SGRId', 'ISpObjectToken',
    'DISPID_SRIsUISupported', 'SpNullPhoneConverter',
    'DISPID_SLPs_NewEnum', 'DISPID_SVSLastBookmarkId',
    'SPEI_END_SR_STREAM', 'DISPID_SPCLangId', 'DISPID_SLPType',
    'DISPID_SOTCSetId', 'DISPID_SVIsUISupported',
    ...
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechBaseStream',
    'DISPID_SAEventHandle', 'DISPID_SPRs_NewEnum', 'SVP_3',
    'DISPID_SVEStreamStart', 'ISpRecognizer',
    'DISPID_SpeechMMSysAudio', 'ISpeechLexiconPronunciation',
    'DISPID_SRCEPropertyNumberChange', 'UINT_PTR', 'SRCS_Disabled',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpAudio', 'SPWORDLIST',
    'SPINTERFERENCE_TOOQUIET', 'SVEViseme', 'SPSEMANTICERRORINFO',
    'ISpEventSink', 'SPPS_Function', 'SPRS_ACTIVE',
    'SPEI_TTS_BOOKMARK', 'DISPID_SVEStreamEnd', 'SVEAudioLevel',
    'SPVPRI_NORMAL', 'SPEI_SOUND_END', 'SPEI_RECOGNITION',
    'SRAExport', 'DISPID_SVEAudioLevel', 'DISPID_SASFreeBufferSpace',
    'eLEXTYPE_PRIVATE20', 'DISPID_SpeechPhraseAlternate', 'SVP_0',
    'DISPID_SPPId', 'DISPID_SVResume', 'DISPID_SPRsCount',
    'SECFNoSpecialChars', 'SSFMOpenForRead', 'SREStateChange',
    'DISPID_SABufferNotifySize', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRGIsPronounceable', 'SAFT32kHz16BitStereo',
    'SPAUDIOSTATE', 'SPSSuppressWord', 'ISpObjectTokenCategory',
    'SAFT24kHz8BitMono', 'SAFT12kHz16BitMono',
    'DISPID_SGRSTNextState', 'SpeechCategoryAudioOut',
    'DISPID_SLGetGenerationChange', 'SGDSActiveUserDelimited',
    'SPEVENTENUM', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechPhraseReplacement', 'SAFTNonStandardFormat',
    'SFTSREngine', 'SpeechGrammarTagWildcard', 'SPBO_PAUSE',
    'ISpRecognizer2', 'SPPHRASEPROPERTY', 'SPEI_START_SR_STREAM',
    'ISpeechGrammarRuleState', 'DISPID_SVSInputWordLength',
    'SPEI_WORD_BOUNDARY', 'ISpPhoneConverter', 'DISPID_SAVolume',
    'DISPID_SLWPronunciations', 'DISPID_SPISaveToMemory', 'SVPOver',
    'SP_VISEME_4', 'SpeechVoicePriority', 'SSTTTextBuffer',
    'ISpeechRecoResultTimes', 'SPEI_INTERFERENCE', 'SDTPronunciation',
    'SPEI_SR_PRIVATE', 'DISPID_SRGetRecognizers', 'SVP_10',
    'ISpPhoneticAlphabetConverter', 'SPPS_RESERVED3', 'SRSEDone',
    'ISpeechCustomStream', 'SpSharedRecoContext',
    'SREPropertyNumChange', 'SECFEmulateResult',
    'ISpeechXMLRecoResult', 'SPWF_INPUT', 'SPPS_Noun',
    'SVSFPersistXML', 'DISPID_SpeechRecoResult2',
    'DISPID_SPIEnginePrivateData', 'SDA_One_Trailing_Space',
    'SpMMAudioOut', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'eLEXTYPE_PRIVATE2', 'DISPID_SDKCreateKey', 'SPVISEMES',
    'SRTSMLTimeout', 'SSTTWildcard',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpeechRecognizerStatus', 'SPAS_PAUSE', 'eLEXTYPE_RESERVED8',
    'SDTAlternates', 'DISPID_SGRSTText', 'SLODynamic',
    'SPPARTOFSPEECH', 'SP_VISEME_12', 'ISpeechPhraseAlternates',
    'SPSEMANTICFORMAT', 'SAFT22kHz8BitStereo',
    'DISPID_SPEEngineConfidence', 'SVESentenceBoundary',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPRuleId', 'ISpGrammarBuilder', 'ISpStream',
    'DISPID_SPARecoResult', 'DISPID_SBSFormat', 'eLEXTYPE_PRIVATE15',
    'SP_VISEME_6', 'SASClosed', 'SpShortcut', 'ISpProperties',
    'DISPID_SGRSTsItem', 'SPPS_Verb', 'DISPID_SGRsAdd',
    'SRSActiveAlways', 'DISPID_SRCEventInterests',
    'DISPID_SpeechLexiconWord', 'eLEXTYPE_PRIVATE3',
    'SAFTNoAssignedFormat', 'SP_VISEME_8', 'SVP_5',
    'SAFT8kHz8BitMono', 'eLEXTYPE_MORPHOLOGY', 'SP_VISEME_11',
    'DISPID_SpeechObjectToken', 'DISPID_SWFEBlockAlign',
    'DISPID_SpeechRecoContext', 'SDA_Two_Trailing_Spaces',
    'SPEI_RECO_STATE_CHANGE', 'SRCS_Enabled', 'DISPID_SVEBookmark',
    'SREStreamStart', 'DISPID_SPRulesCount', 'SAFT48kHz16BitMono',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SGRSTWeight',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SOTs_NewEnum',
    'DISPID_SPPParent', 'SPSHORTCUTPAIRLIST', 'SVSFlagsAsync',
    'SECHighConfidence', 'DISPID_SRRSpeakAudio', 'eLEXTYPE_USER',
    'SpMMAudioEnum', 'ISpeechAudio',
    'DISPID_SRCERecognitionForOtherContext', 'SGRSTTEpsilon',
    'DISPID_SABIMinNotification', 'SpInProcRecoContext', 'SpLexicon',
    'DISPID_SPPName', 'SPPROPERTYINFO', 'DISPID_SDKDeleteKey',
    'SASPause', 'DISPID_SGRsItem', 'SSTTDictation', 'SGDSInactive',
    'SpUnCompressedLexicon', 'DISPID_SDKEnumKeys',
    'eLEXTYPE_PRIVATE12', 'SPPS_RESERVED4', 'DISPID_SRCESoundStart',
    'SWPUnknownWordPronounceable', 'SpPhraseInfoBuilder',
    'SAFT24kHz8BitStereo', 'DISPID_SPEsCount',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SVSVisemeId', 'SVP_13',
    'DISPID_SPEActualConfidence', 'DISPID_SDKGetlongValue',
    'SPFM_CREATE', 'SAFT16kHz8BitStereo', 'SREFalseRecognition',
    'DISPID_SPRFirstElement', 'DISPID_SRSClsidEngine',
    'DISPID_SPPNumberOfElements', 'SpeechTokenIdUserLexicon',
    'SPINTERFERENCE_TOOLOUD', 'SREAudioLevel', 'SPEI_RESERVED6',
    'eLEXTYPE_PRIVATE11', 'DISPID_SOTsCount',
    'DISPID_SpeechAudioFormat', 'DISPID_SpeechLexiconWords',
    'SPFM_NUM_MODES', 'SECFDefault', 'SAFT16kHz16BitMono',
    'SPXRO_SML', 'DISPID_SVSInputWordPosition', 'SRERecognition',
    'SPDATAKEYLOCATION', 'SpeechRegistryUserRoot',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPSNotOverriden',
    'DISPID_SOTCreateInstance', 'SGRSTTWord', 'SDTAll',
    'DISPID_SRCEFalseRecognition', 'DISPID_SpeechRecoResult',
    'SpeechPartOfSpeech', 'eLEXTYPE_PRIVATE14', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechGrammarTagUnlimitedDictation', 'SPWT_LEXICAL', 'SPSVerb',
    'DISPID_SFSClose', 'DISPID_SGRClear',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechRecognizer',
    'eWORDTYPE_DELETED', 'DISPID_SRSAudioStatus', 'SRTAutopause',
    'SPPHRASERULE', 'DISPID_SABufferInfo', 'SVP_8',
    'eLEXTYPE_RESERVED9', 'SLTApp', 'DISPID_SRCERecognition',
    'ISpeechPhraseProperty', 'DISPID_SGRSAddSpecialTransition',
    'SREPropertyStringChange', 'SpMMAudioIn', 'DISPID_SRIsShared',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpeechRecoContext', 'ISpSerializeState',
    'DISPID_SVEVoiceChange', 'SPEI_VISEME',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPRText', 'SITooFast',
